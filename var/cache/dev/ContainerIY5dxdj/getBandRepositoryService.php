 ...
 */
class getBandRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BandRepository.php';

        return $container->privates['App\\Repository\\BandRepository'] = new \App\Repository\BandRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
