...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\BandAutocompleteField' => ['privates', 'App\\Form\\BandAutocompleteField', 'getBandAutocompleteFieldService', true],
            'App\\Form\\MusicianAutocompleteField' => ['privates', 'App\\Form\\MusicianAutocompleteField', 'getMusicianAutocompleteFieldService', true],
            'App\\Form\\Type\\BandCategoryType' => ['privates', 'App\\Form\\Type\\BandCategoryType', 'getBandCategoryTypeService', true],
            'App\\Form\\Type\\BandDetailType' => ['privates', 'App\\Form\\Type\\BandDetailType', 'getBandDetailTypeService', true],
            'App\\Form\\Type\\MusicianCategoryType' => ['privates', 'App\\Form\\Type\\MusicianCategoryType', 'getMusicianCategoryTypeService', true],
            'App\\Form\\Type\\MusicianDetailType' => ['privates', 'App\\Form\\Type\\MusicianDetailType', 'getMusicianDetailTypeService', true],
            ...
            'App\\Form\\BandAutocompleteField' => '?',
            'App\\Form\\MusicianAutocompleteField' => '?',
            'App\\Form\\Type\\BandCategoryType' => '?',
            'App\\Form\\Type\\BandDetailType' => '?',
            'App\\Form\\Type\\MusicianCategoryType' => '?',
            'App\\Form\\Type\\MusicianDetailType' => '?',
